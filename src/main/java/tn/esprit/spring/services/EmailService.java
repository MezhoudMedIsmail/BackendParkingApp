...
public class EmailService {
	...
	public  List<UserEntity>  getAllusers() {
		  List<UserEntity> users = userService.retrieveAllUsers(); // rÃ©cupÃ¨re tous les utilisateurs Ã  partir du service
    ...
    public void sendEmailWithTemplate(UserEntity user){
        // Create a MimeMessage instance using the JavaMailSender
        ...
        try {
            ...
            // Load the email template from a file or as a String
 ...
 // This method will run every day at 10:00 AM(0 0 10 * * ?)  ("0 2(7) 19 * * ?")
